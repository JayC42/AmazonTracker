...
@layer utilities {
  ...
  .section-text {
    @apply textColor text-[32px] font-semibold;
  }
  ...
  .dialog-head_text {
    @apply textColor text-lg leading-[24px] font-semibold mt-4;
  }
  ...
  .nav-logo {
    @apply font-spaceGrotesk text-[21px] textColor font-bold;
  }
  ...
  .product-title {
    @apply textColor text-xl leading-6 font-semibold truncate;
  }
